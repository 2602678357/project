...
insert  into `admin_permission`(`id`,`name`,`desc_`,`url`) values (1,'users_management','用户管理','/api/admin/user'),(2,'roles_management','角色管理','/api/admin/role'),(3,'content_management','内容管理','/api/admin/content');
...
insert  into `admin_role`(`id`,`name`,`name_zh`,`enabled`) values (1,'sysAdmin','系统管理员',1),(2,'contentManager','内容管理员',1),(3,'visitor','访客',1),(9,'test','测试角色',1);
...
insert  into `admin_role_menu`(`id`,`rid`,`mid`) values (19,4,1),(20,4,2),(21,3,1),(22,3,2),(23,9,1),(24,9,2),(77,2,1),(78,2,2),(79,2,4),(80,2,8),(81,2,9),(82,2,10),(121,1,1),(122,1,2),(123,1,3),(124,1,6),(125,1,7),(126,1,4),(127,1,8),(128,1,9),(129,1,10),(130,1,5);
...
insert  into `admin_role_permission`(`id`,`rid`,`pid`) values (83,5,3),(97,2,3),(108,1,1),(109,1,2),(110,1,3);
...
insert  into `admin_user_role`(`id`,`uid`,`rid`) values (40,24,2),(63,3,2),(64,1,1),(65,2,3),(66,2,9);
...
insert  into `category`(`id`,`name`) values (1,'文学'),(2,'流行'),(3,'文化'),(4,'生活'),(5,'经管'),(6,'科技');
...
/*insert  into `user`(`id`,`username`,`password`,`salt`,`name`,`phone`,`email`,`enabled`) values (1,'admin','35b9529f89cfb9b848060ca576237e17','8O+vDNr2sI3N82BI31fu1A==','管理员','12312312312','evan_nightly@163.com',1),(2,'test','85087738b6c1e1d212683bfafc163853','JBba3j5qRykIPJQYTNNH9A==','测试','12312312312','123@123.com',1),(3,'editor','8583a2d965d6159edbf65c82d871fa3e','MZTe7Qwf9QgXBXrZzTIqJQ==','编辑',NULL,NULL,1);*/
...
CREATE TABLE `user` (
  ...
  `name` varchar(255) DEFAULT NULL,
  `nav_item` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8